...
app.post('/games/:gameId/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ads), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourStart), hourEnd: (0, convert_minutes_to_hour_string_1.convertMinutesToHourString)(ad.hourEnd) });
    }));
}));
